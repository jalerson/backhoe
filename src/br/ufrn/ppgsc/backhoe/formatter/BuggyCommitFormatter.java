...
public class BuggyCommitFormatter extends AbstractFormatter {

	public BuggyCommitFormatter(Date startDate, Date endDate,
	...
	public File format() {
		...
		String fileName = systemName+"_"+getHumanizedStartDate()+"_"+getHumanizedEndDate()+"_BuggyCommit.csv";
	...
	public String generateContentFileCSV(Date startDateInterval, Date endDateInterval, List<String> developers){
		String sql = "SELECT d.codeRepositoryUsername, m.value from Metric m, Developer d " +
					 ...
					 "m.minerSlug = 'buggyCommitMiner' and " +
		...
		try {
			...
			String str = "DEVELOPER;BUGGY COMMITS\n";
